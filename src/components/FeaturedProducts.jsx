...
const FeaturedProducts = () => {
  return (
    <section className="w-full">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-12 md:gap-x-10 md:gap-y-20">
          ...
          >
            ...
            <div className="relative aspect-[3/4] overflow-hidden bg-stone-100 rounded-t-full transition-all duration-700 group-hover:shadow-lg">
              ...
              <div className="absolute inset-0 bg-stone-900/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-4 md:p-6">
                <button className="w-full bg-white/95 backdrop-blur-sm text-stone-900 py-3.5 text-[9px] md:text-[10px] uppercase tracking-[0.2em] font-bold flex items-center justify-center gap-2 hover:bg-stone-900 hover:text-white transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
