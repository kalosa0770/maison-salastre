    ...
    <div className="w-full">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
        <div className="space-y-2">
          <span className="text-[10px] tracking-[0.4em] uppercase text-stone-400 block">
            The Current Pulse
          </span>
      ...
      {/* GRID — 2 columns on mobile, 4 on desktop for "Trending" variety */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-12 md:gap-x-8 md:gap-y-16">
        {trendingProducts.map((product, index) => (
          ...
          >
            {/* Image Container */}
            <div className="relative aspect-[3/4] overflow-hidden bg-stone-50 rounded-t-full transition-all duration-500 group-hover:rounded-t-lg shadow-sm">
              <img
                src={product.image}
                alt={product.name}
              ...
              <div className="absolute top-6 left-6">
                <span className="bg-white/80 backdrop-blur-md text-[8px] tracking-[0.2em] uppercase px-3 py-1 text-stone-900 font-bold border border-stone-200">
                  Popular
                </span>
              </div>
              ...
              <div className="absolute inset-0 bg-stone-900/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-4">
                <button className="w-full bg-stone-900 text-white py-3.5 text-[9px] uppercase tracking-[0.3em] font-bold flex items-center justify-center gap-2 hover:bg-black transition-all duration-300">
            ...
            <div className="mt-6">
              <div className="flex justify-between items-start mb-1">
                <p className="text-[8px] md:text-[9px] tracking-[0.2em] text-stone-400 uppercase font-medium">
                  {product.category}
                </p>
